 ...
 */
public enum HotSpotDiagnosticOperation implements Operation
{
    DUMP("dumpHeap", "create a heapdump and save it to a file", new Option[] {
    ...
    LIST("listOptions", "list currently set diagnostic options", new Option[] {
            BeanshooterOption.GLOBAL_CONFIG,
            BeanshooterOption.GLOBAL_VERBOSE,
            BeanshooterOption.GLOBAL_PLUGIN,
            BeanshooterOption.GLOBAL_NO_COLOR,
    ...
    SET("setOption", "set the specified diagnostic option", new Option[] {
            BeanshooterOption.GLOBAL_CONFIG,
            BeanshooterOption.GLOBAL_VERBOSE,
            BeanshooterOption.GLOBAL_PLUGIN,
            BeanshooterOption.GLOBAL_NO_COLOR,
     ...
     */
    HotSpotDiagnosticOperation(String methodName, String description, Option[] options)
    {
        try
        {
