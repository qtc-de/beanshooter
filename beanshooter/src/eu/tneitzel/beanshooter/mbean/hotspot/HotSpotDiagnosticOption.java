package eu.tneitzel.beanshooter.mbean.hotspot;
 ...
 */
public enum HotSpotDiagnosticOption implements Option
{
    OPTION_NAME("option",
                "name of the targeted option",
                Arguments.store(),
                OptionGroup.ACTION,
                ArgType.STRING
               ),
     ...
     */
    HotSpotDiagnosticOption(String name, String description, ArgumentAction argumentAction, OptionGroup optionGroup, ArgType type)
    {
     ...
     */
    HotSpotDiagnosticOption(String name, String description, ArgumentAction argumentAction, OptionGroup optionGroup, ArgType type, String metavar)
    {
        this.name = name;
