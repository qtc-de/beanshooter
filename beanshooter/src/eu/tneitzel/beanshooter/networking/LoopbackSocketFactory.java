package eu.tneitzel.beanshooter.networking;
 ...
 * set these references to localhost or 127.0.0.1 explicitly. This will
 ...
 * objects are open for external access, it is still possible to communicate with them.
 *
 ...
 * with beanshooter, which sets the followRedirect attribute to true. In these cases, a warning
