...
import eu.tneitzel.beanshooter.plugin.IArgumentProvider;
...
public class ArgumentProvider implements IArgumentProvider
{
     ...
     */
     public Object[] getArgumentArray(String[] arguments)
     {
         ...
         try {
             CtClass evaluator = pool.makeClass("eu.tneitzel.rmg.plugin.providers.DefaultArgumentProvider");
    ...
    public String[] getArgumentTypes(String signature, boolean includeName)
    {
        ...
        try {
            CtClass evaluator = pool.makeClass("eu.tneitzel.rmg.plugin.providers.DefaultArgumentProvider2" + System.nanoTime());
