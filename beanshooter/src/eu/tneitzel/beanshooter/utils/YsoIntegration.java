package eu.tneitzel.beanshooter.utils;
...
public class YsoIntegration
{
    ...
    private static Object getTonkaTemplateGadget()
    {
        ...
        java += "Class tonkaBeanClass = java.lang.Class.forName(\"eu.tneitzel.beanshooter.tonkabean.TonkaBean\", true, ucls);";
    ...
    private static Object templateGadgetFromJava(String java)
    {
        ...
        try
        {
            ...
            CtClass payloadClass = pool.makeClass("eu.tneitzel.beanshooter.utils.TransletPayloadStub" + System.nanoTime());
            ...
            CtClass dummyClass = pool.makeClass("eu.tneitzel.beanshooter.utils.Foo" + System.nanoTime());
