...
public enum DiagnosticCommandOption implements Option
{
     ...
     */
    DiagnosticCommandOption(String name, String description, ArgumentAction argumentAction, OptionGroup optionGroup, ArgType type)
    {
     ...
     */
    DiagnosticCommandOption(String name, String description, ArgumentAction argumentAction, OptionGroup optionGroup, ArgType type, String metavar)
    {
        this.name = name;
